...
var _musilitar$musilitarapi$Icon$clickableIconView = F2(
	function (iconName, message) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$class('icon'),
				_1: {
					ctor: '::',
				...
				_0: A2(
					_elm_lang$svg$Svg$use,
					{
						...
						_0: _elm_lang$svg$Svg_Attributes$xlinkHref(
							A2(_elm_lang$core$Basics_ops['++'], '/static/yesyes/dist/icons.svg#', iconName)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
...
var _musilitar$musilitarapi$Board$updateBoardPointClicked = F2(
	function (coordinates, boardPoint) {
		return (_elm_lang$core$Native_Utils.eq(
			...
			boardPoint.x) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Tuple$second(coordinates),
			boardPoint.y)) ? _elm_lang$core$Native_Utils.update(
			boardPoint,
